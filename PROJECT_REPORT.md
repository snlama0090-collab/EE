...
>
> **2026-08-29 cross-reference:** suite check 30c observes this fragility firsthand — the deleted `api/auth/logout.php` endpoint returns **500, not a clean 404**, because missing paths under `/EE` trigger the AH00124 rewrite loop. The 30c assertion intentionally accepts any non-redirect outcome; do not retune it to expect 404 unless this fragility is fixed first.
>
